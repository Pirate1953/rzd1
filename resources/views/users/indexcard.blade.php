      ...
      <div class="row">
        <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
          <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{route('tickets.historyticketusers')}}">{{__('History')}}</a>
            </li>
          </ul>
          ...
          <ul class="nav nav-pills flex-column">
            <li class="nav-item">
              <a class="nav-link active" href="#">{{__('Cards')}}<span class="sr-only">(current)</span></a>
            </li>
          </ul>
        </nav>
        ...
        <main class="col-sm-9 offset-sm-3 col-md-10 offset-md-2 pt-3">
          ...
          <h2>{{__('Список ваших карточек')}}</h2>
              ...
              <thead>
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td>
                          <a class="btn btn-danger" href="{{ route("cards.removecard", $card->id)}}">{{__('Remove card')}}</a>
                      </td>
                  </tr>
                  @endforeach
                </tbody>
