  ...
  <body>
    ...
    <div class="container">
      <div class="py-5 mt-4 text-center">
        <p class="lead" style="font-size: 40px;">{{__('Всего было куплено ')}}{{__($ticket1)}}{{__(' билетов.')}}</p>
      </div>
      ...
      <div class="row">
        <div class="col-md-4 order-md-2 mb-4">
          ...
          <p class="lead">{{__('Эта форма отображает все билеты, которые были куплены (были оплачены).')}}</p>
        </div>
        <div class="col-md-8 order-md-1">
          <h4 class="mb-3">{{__('Билеты')}}</h4>
          <div class="table-responsive">
            <table class="table table-striped">
              <thead>
                <tr>
                  <th>{{ __('Станция отправления') }}</th>
                  <th>{{ __('Станция прибытия') }}</th>
