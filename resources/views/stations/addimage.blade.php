  ...
  <body class="bg-light">
    ...
    <div class="container">
      <div class="py-5 text-center">
        ...
        <h2>{{__('Add image')}}</h2>
        <p class="lead" style="color: black !important;">{{__('Эта форма используется для добавления фотографий к стацнии и сохранения в базу данных.')}}</p>
      </div>
      ...
      <div class="col-md-4 order-md-2 mb-4">
        <h4 class="d-flex justify-content-between align-items-center mb-3">
          ...
          <p class="lead">{{__('Данная форма использует формуляр для добавления картинок на сервер.')}}</p>
      </div>
