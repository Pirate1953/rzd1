    ...
    <div class="container">
      ...
      <div class="col-md-4 order-md-2 mb-4">
        <h4 class="d-flex justify-content-between align-items-center mb-3">
          ...
          <p class="lead">{{__('Эта форма существвует в целях избежания того, что пользователь, случайна нажав на кнопку, удалит тип.')}}</p>
      </div>

    <div class="col-md-8 order-md-1">

    {{-- Форма предъявляется методом HTTP DELETE на веб‑адрес: types/ID, где ID ⁠— первичный ключ --}}
    {{
        Form::model($type, [
            'method' => 'DELETE',
            'route'  => [
