...
<html lang="{{ app()->getLocale() }}">
  <head>
    ...
    <title>{{__('Ticket info check it!')}}</title>
  ...
  <body class="bg-light">
    ...
    <div class="container">
      <div class="py-5 text-center">
        <p></p>
        <h2>{{__('Ticket info check it!')}}</h2>
        <p class="lead" style="color: black !important;">{{__('Эта форма предназначена для подтверждения введённой информации о билете. Прежде чем двигаться дальше проверьте правильность введённых данных и сформированную цену.')}}</p>
      </div>
      ...
      <div class="col-md-4 order-md-2 mb-4">
        ...
        <p class="lead">{{__('Цена расчиатана, исходя из зон. Каждая зона иммеет свою собственную цену.')}}</p>
        <p class="lead">{{__('Исключениями являются зоны в городе Москве - все они имеют одну цену (34 рубля).')}}</p>
      </div>
