  ...
  <body class="bg-light">
    ...
    <div class="container">
      <div class="py-5 text-center">
        ...
        <h2>{{__('Add zone')}}</h2>
        <p class="lead" style="color: black !important;">{{__('Эта форма используется для добавления зон в базу данных. Зоны имееют свою цену, по которой будет расчитываться цена билета.')}}</p>
      </div>
      ...
      <div class="col-md-4 order-md-2 mb-4">
        <h4 class="d-flex justify-content-between align-items-center mb-3">
          ...
          <p class="lead">{{__('Номера зон определяют их порядок следования друг за другом, это ни как не связано с идентификатором в базе данных.')}}</p>
          <p class="lead">{{__('Поле "Цена" предназначено для описания цены, которой будет обладать текущая зона.')}}</p>
      </div>
