  ...
  <body class="bg-light">
    ...
    <div class="container">
      <div class="py-5 text-center">
        ...
        <h2>{{__('Remove station')}}</h2>
        <p class="lead" style="color: black !important;">{{__('Эта форма используется для подтвержения удаления станции, в целях избежания случайного удаления из базы даных.')}}</p>
      </div>
      ...
      <div class="col-md-4 order-md-2 mb-4">
        <h4 class="d-flex justify-content-between align-items-center mb-3">
          ...
          <p class="lead">{{__('Эта форма существвует в целях избежания того, что пользователь, случайна нажав на кнопку, удалит станцию.')}}</p>
      </div>

    <div class="col-md-8 order-md-1">

    {{-- Форма предъявляется методом HTTP DELETE на веб‑адрес: stations/ID, где ID ⁠— первичный ключ --}}
    {{
        Form::model($station, [
            'method' => 'DELETE',
            'route'  => [
